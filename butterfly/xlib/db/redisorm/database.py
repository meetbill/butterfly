...
try:
    from xlib.db.redis import Redis
    from xlib.db.redis.client import pairs_to_dict
    from xlib.db.redis.client import zset_score_pairs
    from xlib.db.redis.exceptions import ConnectionError
    from xlib.db.redis.exceptions import TimeoutError
except ImportError:
    Redis = object
