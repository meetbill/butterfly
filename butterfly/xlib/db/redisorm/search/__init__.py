...
from xlib.db.redisorm.search.metaphone import dm as double_metaphone
from xlib.db.redisorm.search.porter import PorterStemmer
from xlib.db.redisorm.utils import decode
from xlib.db.redisorm.utils import load_stopwords
...
class Tokenizer(object):
    ...
    def stem(self, words):
        ...
        words, e.g.::
            ...
            from xlib.db.redisorm.search.utils import PorterStemmer
    ...
    def metaphone(self, words):
        ...
        Example::
            ...
            >>> from xlib.db.redisorm.search.metaphone import dm as metaphone
