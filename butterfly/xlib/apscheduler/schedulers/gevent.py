...
from xlib.apscheduler.schedulers.blocking import BlockingScheduler
from xlib.apscheduler.schedulers.base import BaseScheduler
...
class GeventScheduler(BlockingScheduler):
    ...
    def _create_default_executor(self):
        from xlib.apscheduler.executors.gevent import GeventExecutor
